function point_cloud=reduce_cells(tissue_data, number_cells)
% tissue data is a .mat explained in the next paragraph with more details. 
% number_cells represents the ammount of cells we're taking from the image.
